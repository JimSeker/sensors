...
public class MainFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mGestureDetector = new GestureDetector(requireActivity().getApplicationContext(), new MyGestureDetector());
    ...
    class myClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            Toast.makeText(requireActivity().getApplicationContext(), "Click!", Toast.LENGTH_SHORT).show();
        }
    ...
    class myLongClickListener implements View.OnLongClickListener {
        ...
        public boolean onLongClick(View v) {
            Toast.makeText(requireActivity().getApplicationContext(), "Long Click!", Toast.LENGTH_SHORT).show();
            return true;
        }
    ...
    class MyGestureDetector extends SimpleOnGestureListener {
        ...
        public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
            ...
            if (Math.abs(dY) < SWIPE_MAX_OFF_PATH &&
                ...
                if (dX > 0) {
                    Toast.makeText(requireActivity().getApplicationContext(), "Right Swipe", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(requireActivity().getApplicationContext(), "Left Swipe", Toast.LENGTH_SHORT).show();
                }
                return true;
                ...
                if (dY > 0) {
                    Toast.makeText(requireActivity().getApplicationContext(), "Up Swipe", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(requireActivity().getApplicationContext(), "Down Swipe", Toast.LENGTH_SHORT).show();
                }
                return true;
            }
            return false;
    ...
    void registerAccelerometer() {
        myManager = (SensorManager) requireActivity().getSystemService(Context.SENSOR_SERVICE);
